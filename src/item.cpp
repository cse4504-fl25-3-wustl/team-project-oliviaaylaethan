...
Item::Item(int lineNo, int quantity, std::string tagNo, 
...
float Item::getDensity() {
    return materialDensity_;
}

float Item::getOuterWidth() {
    return outerWidth_;
}

float Item::getOuterHeight() {
    return outerHeight_;
}

GlazingType Item::getGlazeType() {
    return glazeType_;
}

std::string Item::getFrame1Moulding() {
    return frame1Moulding_;
}

std::string Item::getHardware() {
    return hardware_;
}
